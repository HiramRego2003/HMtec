            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('alta_usuarios')}}">Registrar</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/img/fotor.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Foto Resistencia</a>
                            <p class="card-text">
                                Una fotorresistencia es un componente electrónico cuya resistencia disminuye con el aumento de intensidad de luz incidente. Puede también ser llamado fotorresistor, fotoconductor,
                                 célula fotoeléctrica o resistor dependiente de la luz, cuya siglas, LDR, se originan de su nombre en inglés light-dependent resistor.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/img/DHT11.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Modulo sensor de temperatura y humedad DTH11</a>
                            <p class="card-text">
                                El sensor integrado DHT11 permite obtener datos de la temperatura y humedad ambiente con facilidad.
                                Es utilizable perfectamente en estaciones meteorológicas, locales o remotas, sistemas de control ambiental en el hogar, y equipos de monitoreo de invernaderos, cultivos o jardines.</p>
                        </div>
                    </div>
